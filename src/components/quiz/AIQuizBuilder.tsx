      ...
      <ModalPortal>
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            {/* Error message for malformed AI response */}
            {(!Array.isArray(generatedQuiz.questions)) && (
              <div className="mb-4 text-red-600 text-sm">Quiz data is malformed. Please try again or adjust your prompt.</div>
            )}
            <div className="mb-4">
            ...
            <div className="flex gap-4">
              <button
                onClick={handleSave}
                className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition btn btn-primary"
              >
                Save Quiz
              </button>
              <button
                onClick={() => setShowEditor(false)}
                className="bg-gray-200 text-gray-800 px-4 py-2 rounded hover:bg-gray-300 transition btn btn-secondary"
              >
                Back to Generator
              </button>
            </div>
